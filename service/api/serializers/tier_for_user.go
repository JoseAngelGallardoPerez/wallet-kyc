...
type tierForUser struct {
	fields []interface{}
}

func (t tierForUser) Serialize(ctx context.Context, model interface{}) map[string]interface{} {
	return model_serializer.Serialize(model, t.fields)
}

func (t tierForUser) SerializeList(ctx context.Context, models []model.Tier) []map[string]interface{} {
